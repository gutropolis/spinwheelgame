        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                ...
                <div class="contactus-form">
                    <form name="loginform" id="loginform" method="post" action="/checklogin">
					 {{ csrf_field() }}
                        ...
                        <div class="form-group contact-form-group">                       
                            <input type="Email" name="email" class="form-control contact-form-control" placeholder="Email" autocomplete="off" required>
				 ...
				 <a class="menu-items-in" href="{{ route('signup') }}">Click here to register your account</a>
                <!-- End contactus-form-->
            </div>
        </div>
    </div>
